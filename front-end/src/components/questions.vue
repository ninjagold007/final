...
<div class = "menu">
 ...
 export default {
   ...
   computed: {
     questionList() {
       return this.$root.$data.questionList;
     },
     user() {
    ...
    console.log("getting all questions");
      try {
      this.response = await axios.get("/api/questions/all");
      this.qs = this.response.data
...
console.log("got comments????");
    ...
    this.question = this.response.data[Math.floor(Math.random() * this.response.data.length)];
    }
    },
